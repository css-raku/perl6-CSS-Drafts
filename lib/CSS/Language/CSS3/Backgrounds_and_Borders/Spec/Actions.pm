use v6;
#  -- DO NOT EDIT --
# generated by css-gen-properties.pl --class=CSS::Language::CSS3::Backgrounds_and_Borders::Spec::Actions etc/css3x-background-20120724.txt

class CSS::Language::CSS3::Backgrounds_and_Borders::Spec::Actions {
