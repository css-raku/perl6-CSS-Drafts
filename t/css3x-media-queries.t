...
my $embedded_page_ast = {"media-list" => ["media-query" => ["media" => "print",
                                                            "media-expr" => {"property" => "width", "expr" => ["length" => 21e0]},
                                                            "media-expr" => {"property" => "height", "expr" => ["length" => 29.7e0]}]],
...
for (
    ...
    at-rule => {input => 'media all and (min-color: 2) { }',
                ast => {"media-list" => ["media-query" => ["media" => "all", "media-expr" => {"property" => "min-color", "expr" => ["integer" => 2]}]], "media-rules" => [], "\@" => "media"},
    },
    # try out dpi and dpcm term extensions
    at-rule => {input => 'media all AND (min-resolution: 300dpi) And (min-resolution: 118dpcm) {}',
                ast => {"media-list" => ["media-query" => ["media" => "all", "media-expr" => {"property" => "min-resolution", "expr" => ["resolution" => 300e0]}, "media-expr" => {"property" => "min-resolution", "expr" => ["resolution" => 118e0]}]], "media-rules" => [], "\@" => "media"},
    },
